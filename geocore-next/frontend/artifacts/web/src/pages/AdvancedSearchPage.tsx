...
export default function AdvancedSearchPage() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (form.category !== "All Categories") params.set("category", form.category.toLowerCase().replace(/\s+/g, "-"));
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <form onSubmit={handleSearch} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="p-6 flex items-center justify-between">
            <button
              type="button"
              onClick={() => setForm({ q: "", category: "All Categories", condition: "Any Condition", type: "All Types", minPrice: "", maxPrice: "", currency: "AED", location: "All Locations", sort: "newest", seller: "", freeDelivery: false, featuredOnly: false })}
