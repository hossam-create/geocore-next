...
import { User, Package, Heart, Gavel, Star, Store, Wallet, Settings, ChevronRight, Bell } from "lucide-react";
...
export default function ProfilePage() {
  ...
  const MENU_ITEMS = [
    ...
    { icon: <Heart size={18} />, label: "Saved Items", desc: "Listings you've favorited", href: "/watchlist" },
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
        <ul className="divide-y divide-gray-50">
          <li>
            <Link href="/settings/notifications" className="flex items-center gap-4 px-5 py-4 hover:bg-gray-50 transition-colors group">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-400">Manage email, push & SMS preferences</p>
              </div>
