...
// TableName pins AdminLog to the canonical `admin_audit_log` table (see
// migration 047). Without this override GORM would default to `admin_logs`,
// which migration 047 drops — causing every admin audit insert to fail.
func (AdminLog) TableName() string { return "admin_audit_log" }
