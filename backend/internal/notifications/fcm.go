...
// ════════════════════════════════════════════════════════════════════════════
// DEPRECATED: This file is superseded by internal/push/firebase.go
//
// The canonical FCM client is push.FirebaseClient which implements
// push.FirebaseSender and is wired into push.PushService.
// This file remains only for backward compatibility with Service.fcm field.
// New code should use push.Default().Send() or push.SendPush*() functions.
// ════════════════════════════════════════════════════════════════════════════
...
// DEPRECATED: Use push.FirebaseClient instead.
...
// DEPRECATED: Use push.NewFirebaseClientFromEnv instead.
func NewFCMClientFromEnv() *FCMClient {
	...
	slog.Info("FCM client initialised (deprecated — use push.FirebaseClient)", "project_id", sa.ProjectID)
	return &FCMClient{
...
// DEPRECATED: Use push.Default().Send() instead.
...
// SendMulticast sends a notification to multiple tokens.
// DEPRECATED: Use push.PushService.SendBatch instead.
